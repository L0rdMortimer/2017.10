...
namespace Black_Jack_Maja_V6tab
{
    class Program
    {
            ...
            while (true)
            {
                if (s1 == 1)
                {
                    ...
                    while (true)
                    {
                        ...
                        }////////////////////////////////// sina läksid lõhki või oled valmis tulemuseks
                        else if (s2 == 2)
                        {
                            if (p0 <= m0)
                            {
                            ...
                            if (p0 > m0)
                                ...
                                Console.WriteLine("\nMajal on {0} ({1} ja {2})", m0, m1, m2);
                            Console.WriteLine("Maja on sunnitud juurde võtma");
                            Console.WriteLine("******************************");
                            Console.WriteLine("Jätka");
                            Console.ReadLine();
                            int m3 = deck.Next(2, 12);
                            m0 = m0 + m3;
                            if(p0>m0)
                            {
                                Console.WriteLine("Maja võtis " + m3);
                                Console.WriteLine("Majal on " + m0);
                                Console.WriteLine("Maja on sunnitud juurde võtma");
                                Console.WriteLine("******************************");
                                Console.WriteLine("Jätka");
                                Console.ReadLine();
